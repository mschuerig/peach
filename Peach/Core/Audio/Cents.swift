...
///
/// Cents is a universal unit — not specific to 12-TET. It appears in `Pitch`
/// (baked-in tuning deviation), `Comparison` (cent difference between notes),
/// and `TrainingSettings` (difficulty bounds).
