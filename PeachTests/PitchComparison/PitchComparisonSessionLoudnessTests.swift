...
struct PitchComparisonSessionLoudnessTests {
    ...
    func zeroVariationBothNotesAtZero() async throws {
        ...
        let f = makePitchComparisonSession(userSettings: mockSettings)
    ...
    func fullVariationProducesVariation() async throws {
        ...
        let mockSettings = MockUserSettings()
        mockSettings.varyLoudness = 1.0
        let f = makePitchComparisonSession(comparisons: comparisons, userSettings: mockSettings)
    ...
    @Test("Default makePitchComparisonSession passes varyLoudness 0.0")
