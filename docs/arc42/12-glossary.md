...
| **Observer Fan-Out** | Pattern where sessions notify an array of observers (DataStore, Profile, Haptic, Trend, Timeline) after each completed exercise. Each observer handles its own errors. |
